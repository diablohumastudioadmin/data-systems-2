...
static func generate_resource_class(table_name: String, fields: Array[Dictionary], base_path: String = DEFAULT_STRUCTURES_PATH, constraints: Dictionary = {}, parent_class: String = "") -> Error:
...
static func _generate_script_content(table_name: String, fields: Array[Dictionary], constraints: Dictionary = {}, parent_class: String = "", parent_script_path: String = "") -> String:
	var lines: Array[String] = []
