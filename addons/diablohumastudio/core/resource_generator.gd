...
const BASE_RESOURCES_PATH = "res://addons/diablohumastudio/data_manager/resources/"
...
static func _generate_script_content(definition: DataTypeDefinition) -> String:
	...
	lines.append("")
	lines.append("## Auto-generated Resource class for %s data type" % definition.type_name)
