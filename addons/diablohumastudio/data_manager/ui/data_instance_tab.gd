...
func _refresh_instances() -> void:
	...
	var instances = game_data_system.get_instances(current_type_name)
...
func _on_add_instance_pressed() -> void:
	...
	var instance = game_data_system.create_default_instance(current_type_name)
	game_data_system.add_instance(current_type_name, instance)
	_refresh_instances()
...
func _on_delete_instance_pressed() -> void:
	...
	confirm.confirmed.connect(func():
		game_data_system.remove_instance(current_type_name, index)
		_refresh_instances()
		confirm.queue_free()
	)
...
func _save_current_edits() -> void:
	...
	# Update data system
	game_data_system.data_instances[current_type_name] = new_instances
